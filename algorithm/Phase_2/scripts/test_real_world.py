...
Usage:
    poetry run python -m algorithm.Phase_2.scripts.test_real_world
    poetry run python -m algorithm.Phase_2.scripts.test_real_world --threshold 0.80 --model all-mpnet-base-v2
    poetry run python -m algorithm.Phase_2.scripts.test_real_world --hash
"""
...
from algorithm.Phase_2 import ArbitragePipeline, CandidatePair, MarketQuestion
from algorithm.Phase_2.embedder import HashEmbedder, TransformerEmbedder
