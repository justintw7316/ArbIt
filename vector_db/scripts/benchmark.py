...
Usage:
    cd vector_db
    python scripts/benchmark.py                          # compare all models
    python scripts/benchmark.py --models all-mpnet-base-v2  # single model
    python scripts/benchmark.py --sector politics        # one sector only
"""
