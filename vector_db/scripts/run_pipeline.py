...
Usage:
    ...
    python scripts/run_pipeline.py --threshold 0.75
    python scripts/run_pipeline.py --mongo mongodb+srv://user:pass@cluster.mongodb.net
    MONGO_URI=mongodb://localhost:27017 python scripts/run_pipeline.py
"""
...
from vector_db.mongo_adapter import MongoAdapter
from vector_db.pipeline import ArbitragePipeline
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run step 2 ArbitragePipeline against MongoDB")
    parser.add_argument(
        "--mongo",
